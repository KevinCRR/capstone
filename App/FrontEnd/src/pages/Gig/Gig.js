                ...
                <div className="row pt-4">
                  <div className="col-12">
                    <div className="card-btn-group">
                      <a
                        className="btn btn-primary text-uppercase btn-medium rounded-3 w-180 mr-4"
                        href="/#"
                      >
                        Apply to this job
                      </a>
                      <a
                        className="btn btn-outline-secondary text-black-2 text-uppercase h-px-48 rounded-3 px-5"
                        href="/#"
                      >
                        Save job
                      </a>
                ...
                <div className="row mt-5">
                  ...
                  <div className="col-4">
                    <div className="tags">
                      ...
                      <ul className="list-unstyled mr-n3 mb-0">
                        <li className="d-block font-size-4 text-black-2 mt-2">
                          <span className="d-inline-block mr-2">•</span>HTML
                        </li>
                        <li className="d-block font-size-4 text-black-2 mt-2">
                          <span className="d-inline-block mr-2">•</span>CSS
                        </li>
                        <li className="d-block font-size-4 text-black-2 mt-2">
                          <span className="d-inline-block mr-2">•</span>PHP
                        </li>
                        <li className="d-block font-size-4 text-black-2 mt-2">
                        ...
                        <li className="d-block font-size-4 text-black-2 mt-2">
                          <span className="d-inline-block mr-2">•</span>React.js
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="col">
                    ...
                    <div>
                      ...
                      <ul className="list-unstyled">
                        ...
                        <li className="d-block font-size-4 text-black-2 d-flex flex-row mt-1">
                          <span className="d-inline-block mr-7">•</span>Help set
                      ...
                      <a
                        className="btn btn-primary text-uppercase btn-medium w-180 h-px-48 rounded-3 mr-4 mt-5"
                        href="/#"
                      >
                        Apply to this job
                      </a>
