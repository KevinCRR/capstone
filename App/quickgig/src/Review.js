                ...
                <div className="row">
                  <div className="col-8">
                    <div className="media align-items-center">
                      ...
                      <div>
                        <h3 className="font-size-6 mb-0">Review replies and offers</h3>
                        <span className="font-size-3 text-gray line-height-2">This is where you will see replies and offers of your bids.</span>
                      </div>
                    </div>
                  </div>
                </div>
